...
// git). Every other file that needs Firebase — the admin login page,
// lib/firestore.js for reading/writing data, and lib/storage.js for image
// uploads — imports "auth", "db", or "storage" from here instead of
// connecting to Firebase itself. It runs once, the first time any page
// imports it.
