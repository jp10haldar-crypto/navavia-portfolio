...
// git). Every other file that needs Firebase — like the admin login page —
// imports "auth" from here instead of connecting to Firebase itself. It
// runs once, the first time any page imports it.
